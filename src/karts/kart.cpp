...
#endif
{
    ...
    m_horn_sound = SFXManager::get()->getBuffer("races/horn");
    m_crash_sounds[0] = SFXManager::get()->getBuffer("races/crash");
    m_crash_sounds[1] = SFXManager::get()->getBuffer("races/crash2");
    m_crash_sounds[2] = SFXManager::get()->getBuffer("races/crash3");
    m_goo_sound = SFXManager::get()->getBuffer("items/goo");
    m_boing_sound = SFXManager::get()->getBuffer("items/boing");

    m_engine_sound = NULL;
    for (int i = 0; i < EMITTER_COUNT; i++)
        m_emitters[i] = SFXManager::get()->createSoundSource("races/crash");

    m_skid_sound = NULL;
    m_nitro_sound   = SFXManager::get()->createSoundSource( "races/nitro" );
