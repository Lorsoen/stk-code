...
void Powerup::set(PowerupManager::PowerupType type, int n)
{
    ...
    switch (m_type)
    {
        ...
        case PowerupManager::POWERUP_BOWLING:
            m_sound_use = SFXManager::get()->createSoundSource("items/bowling_shoot");
            break ;

        case PowerupManager::POWERUP_ANVIL:
            m_sound_use = SFXManager::get()->createSoundSource("ui/anvil");
            break;

        case PowerupManager::POWERUP_PARACHUTE:
            m_sound_use = SFXManager::get()->createSoundSource("items/parachute");
            break;

        case PowerupManager::POWERUP_BUBBLEGUM:
            m_sound_use = SFXManager::get()->createSoundSource("items/goo");
            break ;

        case PowerupManager::POWERUP_SWITCH:
            m_sound_use = SFXManager::get()->createSoundSource("races/swap");
            break;
        ...
        default :
            m_sound_use = SFXManager::get()->createSoundSource("items/shoot");
            break ;
    }
    ...
    case PowerupManager::POWERUP_BUBBLEGUM:
        ...
        else // if the kart is looking forward, use the bubblegum as a shield
        {
            ...
            if (!has_played_sound)
            {
                ...
                m_sound_use = SFXManager::get()->createSoundSource("items/inflate");
